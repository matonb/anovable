...
try:
    ...
    raise ImportError("Please install bleak: pip install bleak")
...
class AnovaBLE:
    ...
    async def discover_device(self) -> Optional[str]:
        ...
        try:
            ...
            raise AnovaConnectionError(f"Failed to scan for devices: {e}")
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self.characteristic = self.client.services.get_characteristic(CHARACTERISTIC_UUID)
            ...
            await self.disconnect()
            raise AnovaConnectionError(f"Connection failed: {e}")
    ...
    async def _send_command(self, command: str) -> str:
        ...
        try:
            ...
            raise AnovaTimeoutError(f"Timeout waiting for response to: {command}")
